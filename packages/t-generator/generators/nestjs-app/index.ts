...
class NestAppGenerator extends GeneratorBase {
  ...
  writing(): void {
    ...
    const templateFiles = [
      ...
      ['src/modules/auth/auth.controller.ts.ejs', 'src/modules/auth/auth.controller.ts'],
      ['src/modules/auth/auth.module.ts.ejs', 'src/modules/auth/auth.module.ts'],
      ['src/modules/auth/auth.service.ts.ejs', 'src/modules/auth/auth.service.ts'],
      ['src/modules/auth/current-user.decorator.ts.ejs', 'src/modules/auth/current-user.decorator.ts'],
      ['src/modules/auth/dto/login.dto.ts.ejs', 'src/modules/auth/dto/login.dto.ts'],
      ['src/modules/auth/dto/refresh-token.dto.ts.ejs', 'src/modules/auth/dto/refresh-token.dto.ts'],
      ['src/modules/auth/guards/access-token.guard.ts.ejs', 'src/modules/auth/guards/access-token.guard.ts'],
      ['src/modules/auth/jwt.strategy.ts.ejs', 'src/modules/auth/jwt.strategy.ts'],
      ['src/test/auth.test.ts.ejs', 'src/test/auth.test.ts'],
